...
%><%@ page import="com.day.cq.wcm.api.WCMMode,com.dupont.phoenix.list.HListHelper,
				...
				com.dupont.phoenix.mchlm.newshlm.NewsHLM,
...
try {
	...
	final NewsHLM hlmHelper = (NewsHLM) request.getAttribute("hListHelper");
	...
	if(listSize > 0 && showHLM) {		
		...
		hlmHelper.addSortingComparator(CreatedDateComparator.DESCENDING);
