...
<%
%><%@ page
    import="com.day.cq.commons.Doctype,com.dupont.phoenix.Global,
...
<%
    ...
    final String domain = String.format("prod_%s",StringUtils.lowerCase(Global.getCountryCode(currentPage)));

    // canonical url
    // set vanity path (prepare canonical url)
    if(Global.isEdit(slingRequest)) {
        //Global.setVanityPath(currentPage);
    }
...
<!-- Removing the Tracker <cq:include script="stats.jsp" /> -->
<% if (favIcon != null) { %>
...
<script type="text/javascript">var ie7 = false;var s=document.getElementsByTagName("script")[0]; var s7domain=document.location.protocol+"<%= GlobalConstants.s7domain %>";</script>

<!--[if lt IE 8]>
        <script type="text/javascript">ie7 = true;</script>
        <script type="text/javascript" src="/etc/designs/dupont/phoenix/responsiveclientlib/source/js/selectivizr-min.js"></script>
        <link rel="stylesheet" type="text/css" href="/etc/designs/dupont/phoenix/responsiveclientlib/source/css/ie7-overrides.css" />
    <![endif]-->
<!--[if lt IE 9]>
        <script type="text/javascript" src="/etc/designs/dupont/phoenix/responsiveclientlib/source/js/selectivizr-min.js"></script>
        <link rel="stylesheet" type="text/css" href="/etc/designs/dupont/phoenix/responsiveclientlib/source/css/ie8-overrides.css" />
    <![endif]-->
<!--[if IE 9]>
        <link rel="stylesheet" type="text/css" href="/etc/designs/dupont/phoenix/responsiveclientlib/source/css/ie9-overrides.css" />
    <![endif]-->
</head>
