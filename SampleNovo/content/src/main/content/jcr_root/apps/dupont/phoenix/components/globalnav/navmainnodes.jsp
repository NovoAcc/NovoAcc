...
<%
    ...
    if (nodePage != null){
        ...
        String nodePageTitleTranslate= nodePageTitle= Global.getTranslatedText(currentPage, slingRequest, nodePage.getName() );
        if (!nodePageTitleTranslate.equals(""))
            nodePageTitle = nodePageTitleTranslate;
...
%>
        <li class="navigation-item n<%=index%>">
           <span class="global-mega-link"> <%= nodePageTitle %></span>
