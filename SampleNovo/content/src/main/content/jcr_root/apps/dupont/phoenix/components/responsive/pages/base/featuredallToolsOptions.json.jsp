...
%><%
    ...
    jw.array();
		...
		jw.object();
			...
			jw.key("value").value("dupont/phoenix/components/responsive/touttool");
		jw.endObject();
		jw.object();
			jw.key("text").value("Featured Module A");
			jw.key("value").value("dupont/phoenix/components/featureda");
		jw.endObject();
	jw.endArray();
%>