	<%@page import="com.dupont.phoenix.hlm.PublishDateComparator"%>
	...
	%><%@ page import="com.day.cq.wcm.api.WCMMode,com.dupont.phoenix.list.HListHelper,
					...
					com.dupont.phoenix.mchlm.MCHLM,
					...
					com.dupont.phoenix.hlm.CreatedDateComparator,
	...
	try {
		...
		final MCHLM hlmHelper = (MCHLM) request.getAttribute("hListHelper");
		...
		if(listSize > 0 && showHLM) {		
			...
			if(contentType.equalsIgnoreCase("mcdailynews"))
	        {
	        ...
	        else if(contentType.equalsIgnoreCase("presskit"))
	        {
	            hlmHelper.addSortingComparator(LastModificationDateComparator.DESCENDING);
				hlmHelper.sortListItems();
	        }
	...
	<%if(!"dupont/phoenix/components/linklistcurated".equals(selectedTool))  { %>
