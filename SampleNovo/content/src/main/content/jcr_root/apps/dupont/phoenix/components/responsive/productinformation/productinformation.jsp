        ...
        <c:choose>
            ...
            <c:when test="${firstGroupItemslength>0 && secondGroupItemslength<=0 && empty checkIncludeTool}">
                <%
                    ...
                    firstColumnDiv = "<div class='two-third prod-info group'>"; firstColumnDivEnd = "";
                    secondColumnDiv = ""; secondColumnDivEnd = "</div>";
            ...
            <c:when test="${firstGroupItemslength>0 && secondGroupItemslength<=0 && not empty checkIncludeTool}">
                <%
                    ...
                    firstColumnTitle = "<h2>" + firstGroupTitle+ "(" + firstGroupItems.length + ")" +"</h2>";
                    firstColumnDiv = "<div class='prod-info group'>"; firstColumnDivEnd = "";
                    secondColumnDiv = "";  secondColumnDivEnd = "";
                    thirdColumnDiv = "";thirdColumnDivEnd = "</div>";
            ...
            <c:when test="${firstGroupItemslength>0 && secondGroupItemslength>0 && empty checkIncludeTool}">
                <%
                    ...
                    firstColumnDiv = "<div class='one-third prod-info group'>"; firstColumnDivEnd = "</div>";
                    secondColumnDiv = "<div class='one-third prod-info group'>"; secondColumnDivEnd = "</div>";
                ...
                <c:choose>
                    ...
                    <c:when test="${firstGroupItemslength>=secondGroupItemslength}">
                        <%
                            ...
                            firstColumnDiv = "<div class='two-third prod-info group'>"; firstColumnDivEnd = "";
                            secondColumnDiv = ""; secondColumnDivEnd = "</div>";
                            thirdColumnDiv = "<div class='one-third prod-info group'>";thirdColumnDivEnd = "</div>";
                    ...
                    <c:otherwise>
                        <%
                            ...
                            secondColumnTitle ="<h2>"+ secondGroupTitle + " (" + secondGroupItems.length + ")"+"</h2>";
                            firstColumnDiv = "<div class='one-third prod-info group'>"; firstColumnDivEnd = "</div>";
                            secondColumnDiv = "<div class='two-third prod-info group'>"; secondColumnDivEnd = "";
                            thirdColumnDiv = "";thirdColumnDivEnd = "</div>";
...
<section class="row group product_information_group">
...
<% try { %>
    ...
    %>
            <div class="clr"></div>
            <div class='prod-info show-all-wrap group'>
    ...
    <% } %>
        ...
        <c:choose>
            <c:when test="${empty checkIncludeTool}">
                <cq:include script="/apps/dupont/phoenix/components/responsive/common/listviews/listrow-with-callout-pim.jsp"/>
            </c:when>
            <c:otherwise>
