(function($) {
  ...
  $(function () {
	...
	/*$('#ExpertGrid').jcarousel({  // Carousel intialization
		scroll: 1
	});
	...
	// Wire up grey paginations dots for navigation between grid views
	...
	*/
	...
	// Review, validate if this is prototype code
	...
	// Wire up hover events for each of the experts to show coloured profile pics
	...
	// Wire up the slide up and down for the primary and secondary solutions
	$('.xpt-1-sol-bottom-1').click(function() {
 		$('.xpt-1-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-1-sol-bottom-2').click(function() {
 		$('.xpt-1-sol').animate({'top':"0"},100);
	});

	$('.xpt-2-sol-bottom-1').click(function() {
 		$('.xpt-2-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-2-sol-bottom-2').click(function() {
 		$('.xpt-2-sol').animate({'top':"0"},100);
	});

	$('.xpt-3-sol-bottom-1').click(function() {
 		$('.xpt-3-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-3-sol-bottom-2').click(function() {
 		$('.xpt-3-sol').animate({'top':"0"},100);
	});

	$('.xpt-4-sol-bottom-1').click(function() {
 		$('.xpt-4-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-4-sol-bottom-2').click(function() {
 		$('.xpt-4-sol').animate({'top':"0"},100);
	});

	$('.xpt-5-sol-bottom-1').click(function() {
 		$('.xpt-5-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-5-sol-bottom-2').click(function() {
 		$('.xpt-5-sol').animate({'top':"0"},100);
	});

	$('.xpt-6-sol-bottom-1').click(function() {
 		$('.xpt-6-sol').animate({'top':"-361px"},100);
	});
	$('.xpt-6-sol-bottom-2').click(function() {
 		$('.xpt-6-sol').animate({'top':"0"},100);
	});
