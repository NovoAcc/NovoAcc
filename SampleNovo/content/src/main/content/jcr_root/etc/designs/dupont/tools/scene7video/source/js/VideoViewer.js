( function(window, document, $, undefined) {
	...
	var expose = ( function(){
		...
		function initViewer(){
			...
			_scene7FileName = $("#videoplayerid").attr("data-s7videoPath");
		    _imageFileName = $("#videoplayerid").attr("data-s7imagePath");
		    ...
		    params.push("posterimage", _imageFileName);
		    params.push("autoplay", "0");
		    params.push("stagesize", "715,402");
